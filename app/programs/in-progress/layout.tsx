...
export default function Layout({
    ...
    if (programInProgressDetails) {
      ...
      if (lessonDetails) {
        if (lessonDetails.passed === -1) {
          ...
          console.log("---------------------");
          console.log(lastInProgressLessonDetails);
  ...
  return (
    <>
      ...
      <div className="grid-system-level0 grid grid-cols-4 py-10">
        {/* left side */}
        <div className="col-span-1 space-y-5 sticky top-[5rem] h-fit max-w-80">
          {/* title */}
          <h3 className="title-large text-on_surface-light">Program Content</h3>

          <div className="border border-outline-level1 rounded divide-y divide-outline-level0">
                    ...
                    {content.lessons.map((lesson) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <h5
                            className={`title-small transition-all ease-in-out duration-300 ${
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <h6 className="label-small text-txt-on-surface-secondary-light">
                            12:32
                          </h6>
                        </div>
                      </div>
        ...
        {/* right side / details */}
        <div className="col-span-3 grid-system-level0">{children}</div>
      </div>
    </>
  );
}
