...
function Page() {
  ...
  return (
    <div className="space-y-6 pt-10">
      <div className="grid grid-cols-3 gap-6 grid-system-level1">
        {/* left side */}
        <div className="col-span-2 space-y-10">
          {/* title */}
          <h2 className="title-large text-on_surface-light">Partners</h2>
        ...
        {/* card */}
        <div className="sticky top-[4.5rem] col-span-1 bg-shades-light-90 rounded-sm border border-outline-level0 pt-6 pb-4 px-6 space-y-6 h-fit">
          {/* title */}
      ...
      <section className="hero2 grid-system-level0">
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-1 flex flex-col items-start gap-3 z-[999] py-10">
            <h3 className="text-start title-medium text-txt-on-primary-dark">
              Representative Inquiry
            </h3>
            <div className="space-y-2 w-fit">
              <h4 className="text-start title-small text-txt-on-primary-dark">
                Verify the Status of Our Representatives
              </h4>

              <div className="text-start space-y-10 body-large text-txt-on-primary-dark">
                ...
                <p className="flex gap-2">
                  ...
                  <a href="#" className="underline">Contact@camacollege.ca.</a>
                </p>
              </div>
            </div>
          </div>
          ...
          {/* credential inquiry */}
          <div className="col-span-1 z-[999] flex items-center justify-center">
